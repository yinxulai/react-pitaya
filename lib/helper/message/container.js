...
__any_css_style_inject__("._overlay_1y2vl_1 {\n  top: 0;\n  left: 0;\n  z-index: 1;\n  position: fixed;\n}\n._entitiesRoot_1y2vl_7 {\n  top: 0;\n  left: 0;\n  position: absolute;\n}\n._mask_1y2vl_12 {\n  top: 0;\n  left: 0;\n  width: 100vw;\n  height: 100vh;\n  overflow: auto;\n  position: absolute;\n  background-color: rgba(0, 0, 0, 0.01);\n}\n");
        var style$1 = {"overlay":"_overlay_1y2vl_1","entitiesRoot":"_entitiesRoot_1y2vl_7","-webkit-mask":"_mask_1y2vl_12","mask":"_mask_1y2vl_12","webkitMask":"_mask_1y2vl_12"};
...
class Container$1 extends React.Component {
    ...
    get overlayEntities() {
        ...
        if (overlays && overlays.size > 0) {
            ...
            return entries.map(([id, overlay]) => {
                ...
                return (React.createElement(Container, { className: [style$1.entitiesRoot], style: { zIndex: id }, key: String(id) },
                    isShowMask && React.createElement(Container, { className: [style$1.mask], onClick: maskCloser }),
    ...
    render() {
        return [
            this.props.children,
            React.createElement(Container, { className: [style$1.overlay] }, this.overlayEntities)
        ];
    }
}
__decorate([
...
class Container$2 extends React.Component {
    ...
    render() {
        return (React.createElement(Container, { className: [style.container] }, this.messages.map((message, index) => (React.createElement(Message, Object.assign({}, message))
...
export { Container$2 as Container };
