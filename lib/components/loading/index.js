...
__any_css_style_inject__("._loading_1iu2l_1 {\n  position: relative;\n}\n._loadingMark_1iu2l_4 {\n  z-index: 1;\n  display: block;\n  position: relative;\n}\n");
        var style = {"loading":"_loading_1iu2l_1","loadingMark":"_loadingMark_1iu2l_4"};
...
// TODO: 待实现
const Loading = props => {
    return (React.createElement(Container, { className: [style.loading, props.className], style: props.style },
        props.loading &&
            (React.createElement("div", { className: style.loadingMark }, "\u52A0\u8F7D\u4E2D...")),
        React.createElement("div", { className: style.context }, props.children)));
};
