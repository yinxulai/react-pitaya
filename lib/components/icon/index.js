...
__any_css_style_inject__("._icon_1c7va_1 {\n  position: relative;\n}\n");
        var styles = {"icon":"_icon_1c7va_1"};
...
const Icon = props => {
    ...
    return (React.createElement(Container, { className: [styles.icon, className], style: style },
        React.createElement("i", { style: { color, fontSize: size }, className: `icon-${name}` })));
};
