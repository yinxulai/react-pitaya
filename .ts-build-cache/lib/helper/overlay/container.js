    ...
    class Container extends react_1.default.Component {
        ...
        get overlayEntities() {
            ...
            return [...overlays.entries()].map(([id, overlay]) => {
                ...
                return (react_1.default.createElement(container_1.default, { className: [style_less_1.default.entitiesRoot], style: { zIndex: sortID }, key: id }, isShowMask && react_1.default.createElement(container_1.default, { className: [style_less_1.default.mask], onClick: maskCloser }), overlay.render(this.generateCloser(id))));
            }).filter(Boolean);
        }
        render() {
            const sortID = Date.now();
