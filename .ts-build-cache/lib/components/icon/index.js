...
(function (factory) {
    ...
    exports.Icon = props => {
        ...
        return (react_1.default.createElement(container_1.default, { className: [style_less_1.default.icon, className], style: style }, react_1.default.createElement("i", { style: { color, fontSize: size }, className: `icon-${name}` })));
    };
