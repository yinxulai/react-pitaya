...
var Listener = /** @class */ (function () {
    ...
    Listener.prototype.addListener = function (subscriber) {
        var _this = this;
        var symbol = Symbol();
        this.subscribers.set(symbol, subscriber);
        return function () { return _this.removeListener(symbol); };
    };
    Listener.prototype.removeListener = function (symbol) {
        return this.subscribers.delete(symbol);
    };
    Listener.prototype.dispatchSubscribers = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        if (!(index < subscribers.length)) return [3 /*break*/, 4];
                        return [4 /*yield*/, subscribers[index]()];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3:
